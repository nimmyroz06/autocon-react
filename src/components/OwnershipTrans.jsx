...
const OwnershipTrans = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        formData.append('ownerName', ownerName); // Include the owner's name in the form data
        ...
        try {
            ...
            if (response.status === 200) {
                ...
                setSelectedFiles([null, null, null, null]); // Reset the selected files
                setOwnerName(''); // Reset the owner name
            } else {
